...
export const ultimaRottaWeapon: TableConfig[] = [
  ...
  {
    id:'ULTIMA_ROTTA.ENERGY_WEAPONS',
  ...
  {
    id:'ULTIMA_ROTTA.MECHANICAL_WEAPONS',
...
export const ultimaRottaCriticDamage: TableConfig[] = [
  {
    id:'ULTIMA_ROTTA.TABLE.CRITIC_DAMAGE',
