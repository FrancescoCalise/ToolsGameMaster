...
import { CharacterSheetLUR } from './component/game-layout/games/ultimaRotta/features/generate-character-lur/charachter-sheet-lur';
...
export const CHARECTER_SHEET_LUR = new InjectionToken<FirestoreService<CharacterSheetLUR>>('charecterSheetLur');
