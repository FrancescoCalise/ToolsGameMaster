...
function translateValues(obj) {
    ...
    if (typeof obj === 'object' && obj !== null) {
        var translatedObj = Array.isArray(obj) ? [] : {};
        for (var key in obj) {
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var inputFilePath, jsonData, translatedJson;
        return __generator(this, function (_a) {
            inputFilePath = path.resolve(process.argv[2]);
            try {
                jsonData = JSON.parse(fs.readFileSync(inputFilePath, 'utf8'));
                translatedJson = translateValues(jsonData);
